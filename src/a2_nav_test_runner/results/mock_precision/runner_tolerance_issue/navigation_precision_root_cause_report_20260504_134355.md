...
- Primary root cause: `runner_arrival_tolerance`
...
- count: `5`
- backend_success_rate: `0.0000`
- runner_arrival_success_rate: `1.0000`
- mean_final_error_tf_map_base_link: `0.2947`
- mean_final_error_tf_map_base_footprint: `0.2947`
- max_final_error_tf_map_base_link: `0.3045`
- std_final_error_tf_map_base_link: `0.0070`

## 5. Static Pose Stability

- tf_map_base_x_std: `0.0057`
- tf_map_base_y_std: `0.0051`
- amcl_x_std: `0.0001`
- amcl_y_std: `0.0026`
- odom_x_std: `0.0000`
- odom_y_std: `0.0000`
...
- Primary suspect from current evidence: `runner_arrival_tolerance`.

## 8. Evidence-Based Recommendations

- Reduce runner arrival tolerance and keep backend success separate from runner success.
- Do not treat runner arrival success as backend navigation success.
...
- Runner arrival success is high while backend success is low.
